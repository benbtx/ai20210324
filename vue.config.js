...
module.exports = {
  ...
  //   proxy: {
  //     // '/sys': {
  //     //     target: 'http://192.168.7.233:8882',
  //     //     changeOrigin: true,
  //     //     pathRewrite: {
  ...
  //     // },
  //     '/workspaces/': {
  //       target: 'http://192.168.7.241:9090',
  //       changeOrigin: true
  //     },
  //     '/workLine/': {
  //       target: 'http://192.168.7.235:7200',
  //       changeOrigin: true
  //     },
  //   },
  // },
  ...
  devServer: {
    ...
    proxy: {
      ...
      '/api': {
        target: 'http://192.168.7.233:8883',
        changeOrigin: true,
        pathRewrite: {
          '^/api': '/api'
        }
          ...
          config
            .optimization.splitChunks({
              ...
              cacheGroups: {
                ...
                // coms: {
                //   name: 'chunk-coms',
                //   test: /[\\/]node_modules[\\/]/, // can customize your rules
